...
{\centering \includegraphics[width=0.9\textwidth,height=\textheight]{thesis_manuscript_files/figure-pdf/fig-mapdetail-1.pdf}
...
{\centering \includegraphics[width=0.9\textwidth,height=\textheight]{thesis_manuscript_files/figure-pdf/fig-mapoverview-1.pdf}
...
{\centering \includegraphics[width=0.9\textwidth,height=\textheight]{thesis_manuscript_files/figure-pdf/fig-mapWSdetail-1.pdf}
...
\subcaption{\label{fig-dst308-1}Raw depthlog, subsampled to one value
every 30 minutes.}
\end{minipage}%
\newline
...
\subcaption{\label{fig-dst308-3}Example subset from Febuary and March
2019.}
\end{minipage}%
...
\subcaption{\label{fig-dst321-1}Raw depthlog, subsampled to one value
every 30 minutes.}
\end{minipage}%
\newline
\begin{minipage}[t]{0.50\linewidth}
...
\subcaption{\label{fig-dst321-3}Example subset from Febuary and March
2019.}
\end{minipage}%
...
\addcontentsline{toc}{subsubsection}{\textbf{A1}: Raw depth and
temperature logs}
...
\addcontentsline{toc}{subsubsection}{\textbf{A2}: Fast Fourier
Transformation}
