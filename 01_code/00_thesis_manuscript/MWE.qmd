...
# table %>%
#   mutate_all(linebreak(x = table, align = "c")) %>%
...
# 
# # use linebreak to introduce line breaks in column names
# names(df) <- linebreak(names(df), align = "c")
# 
...
# generate a data frame with long column names
df <- data.frame("Long.Column.Name.1" = rnorm(10), "Long.Column.Name.2" = rnorm(10))

# replace periods with line breaks in column names
