...
## General Questions to Jan, Niels and Carlota {-}
...
The starry smooth-hound shark (*Mustelus asterias*, Cloquet 1819) is a medium-sized triakid elasmobranch, measuring around 30 cm in total length (TL) at birth and 120 cm (females) and 100 cm (males) when reaching sexual maturity [@farrell_2010]. It can attain up to 140 cm TL [@mccullyphillips_2015].
...
<!-- **map with geolocation output by Jolien here** -->

**MAP**
<!-- ::: {#fig-mapgeolocation} -->
<!-- ![Placeholder for the geolocation output map(s)](C:/Users/lotte.pohl/Documents/github_repos/MasterThesis_LottePohl/01_code/00_thesis_manuscript/maps/map_geolocation_output_placeholder.png) -->
<!-- ::: -->
...
*is the study area the BPNS and the Scheldt, because there sharks were tagged? What are the greater north sea and the english channel for the study, as sharks putatively moved there during migration? solve*
...
Females were significantly larger than males (one-sided Welch Two Sample t-test, $\alpha$ = 0.95, *p* = `r length_ttest$p.value`), see @fig-lengthboxplot.
...
todo: write tagging year in caption, include temperature!
...
#| label: fig-dst295
#| out-width: 75%
#| fig-cap: "Depth log from the recovered tag 295. This male was tagged on July 19, 2018. Question: include raw depthlogs of 308 and 321?"
#| fig-pos: "H"
...
```{r wavelet-min}
#| include: true
#| label: fig-wave_depthmin
#| layout-ncol: 1
#| column: body #page
#| fig-width: 8
#| fig-cap: "Wavelet transform results from the daily minimum depth."
#| fig-subcap: 
#| - "female shark (tag 308)"
#| - "male shark (tag 321)"
#| 
