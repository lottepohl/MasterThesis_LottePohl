...
The autocorrelation plots of the two long term DST logs are shown in @fig-acf308 and @fig-acf321.
...
The summary statistics of the depthlogs of tags 308 and 321 are displayed in @fig-dstsum308 and in @fig-dstsum321.
...
#| out-width: 100%
#| fig-height: 2.5
#| fig-cap: "Wavelet transform results from the daily median depth. The fully opaque areas refer to periods that significantly differ from white noise."
#| fig-subcap: 
#| - "Daily median depth"
#| - "Daily minimum depth"
#| - "Daily maximum depth"
