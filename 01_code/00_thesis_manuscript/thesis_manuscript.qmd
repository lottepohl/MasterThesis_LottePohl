...
knitr::kable(x = tagged_animal_info %>% 
  ...
  kableExtra::kable_styling(position = "center", latex_options = "HOLD_position") %>%  kableExtra::kable_styling(font_size = 7)
...
#| out-width: 80%
#| layout-ncol: 1
#| fig-cap: "Overview maps of the study area. Panel **a)** shows the Belgian Part of the North Sea (BPNS) and the Scheldt estuary. Panel **b)**  shows the Southern North Sea and the English Channel. Bold labels refer to relevant locations, italicised labels refer to relevant receiver stations."
#| fig-subcap:
#| - "The Belgian Part of the North Sea (BPNS) and the Scheldt estuary.  ES = Eastern Scheldt, WS = Western Scheldt. Each black circle marks one acoustic receiver station."
...
<!-- #### Summary Statistics {#sec-mm-sumstats} -->
