...
#| out-width: 100%
#| fig-height: 3
#| fig-cap: "Heatmap of the acoustic detections per acoustic receiver of female *M. asterias* in the Western Scheldt (receiver arrays *WS1*, *WS2* and *WS3*)."
#| fig-pos: "H"
...
The two lines of research encompass the assessment of seasonality and sex-specificity regarding the presence of *M. asterias* in the BPNS and the Western Scheldt, and its vertical movement behaviour. The following section will interpret and discuss the chosen analyses and their results with respect to the research questions stated in @sec-intro-aims.

 <!-- - write a few introductory sentences about what happened in the study and during the analyses. -->

<!-- ## Acoustic Detections -->

## Presence of *M. asterias* in the Western Scheldt and BPNS {#sec-disc-seasonalpresencefemales}
...
## Depth utilisation of *M. asterias* {#sec-disc-dst-movementpatterns}
...
In addition, the placement of an acoustic receiver off the coast of Zoetelande might give further insights into possible seasonal aggregation of *M. asterias* in summer, as described by fishers[^3].
