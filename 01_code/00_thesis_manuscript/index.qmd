...
The pressure sensors recorded with a resolution of 0.3m and an accuracy of \pm3.4m until the depth of 68m, according to the manufacturer (**ref**).
...
The depth log of tag 304 is shown below (see @fig-dst295).

```{r}
#| include: true
#| label: fig-dst295
#| out-width: 75%
#| fig-cap: "Depth log from the recovered tag 295."
plot_dst_295
```
...
The summary statistics for dst tag 308 and 321 are displayed in @fig-dstsummary.
...
p_321_depth_median_range_change_ribbon
```

The result of the autocorrelation analysis is shown in @fig-acf308.
...
# wavelet plots of median depth - or other variable?
