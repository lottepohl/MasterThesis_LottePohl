# Script to prepare data from the Hackathon results to plot in manuscript
...
## 1.1. functions ####
dir_path_hackathon <- "C:/Users/lotte.pohl/Documents/github_repos/OpenSeaLabHackathon_SmoothSharks" 
dir_path <- "C:/Users/lotte.pohl/Documents/github_repos/MasterThesis_LottePohl"
path_results <- paste0(dir_path, "/02_results/acoustic_vertical_space_use/")

source(paste0(dir_path_hackathon, "/01_code/load_save_rds_files.R"))
source(paste0(dir_path_hackathon, "/01_code/01_load_data/load_acoustic_detections.R"))
# source("C:/Users/lotte.pohl/Documents/github_repos/MasterThesis_LottePohl/01_code/06_functions/ggplot_geom_split_violin.R")

## 1.2 load_data ####

summary_all <- load_data(filestring = "summary_all", folder = paste0(dir_path_hackathon, "/02_results_plots/"))
...
# save data ####
save_data(data = summary_all2, folder = path_results)
save_data(data = summary_wide2, folder = path_results)
